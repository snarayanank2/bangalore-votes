  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 px-4 py-8">
      <div>
        ...
        <h1 className="text-2xl text-ink sm:text-3xl">{ward.name}</h1>
      </div>
      ...
      <section aria-label="Ward boundary map">
        <div
          ...
          className="flex h-40 items-center justify-center rounded-md border-2 border-dashed border-gray-300 bg-gray-100 px-4 text-center text-sm text-ink/60"
        >
      ...
      <nav aria-label="Ward pages" className="grid gap-3 sm:grid-cols-3">
        <Link
          ...
          className="rounded-md border border-gray-300 p-3 text-center text-sm font-medium text-ink hover:border-forest"
        >
