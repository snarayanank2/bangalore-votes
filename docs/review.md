...
>
> **Superseded (2026-07-17):** Decision reversed — visitor and event data is now tracked in **Google Analytics**, backing new release targets of 300,000 unique visitors and 25,000 registered users. GA added to GTM §8, the `/privacy` disclosures (PRD §5.16, IA §3.18), PRD §12 NFRs and §14 locked decisions, and the dependency register (deps §6.12). Server-side application events remain the source of truth for registration counts.
